...
function clickIsOrgN(){
       // $('input:radio[name="yes"]').removeAttr("checked");

    $('input:radio[name="yes"]').attr("checked",null);
}
function clickIsOrgY(){
        //$('input:radio[name="no"]').removeAttr("checked");
    $('input:radio[name="no"]').attr("checked",null);
}
function clickIsOrgNa(){
    $('input:radio[name="shi"]').removeAttr("checked");
}
function clickIsOrgYa(){
    $('input:radio[name="fou"]').removeAttr("checked");
}
...
function addOrg() {
    ...
    var isOrg=1;
    var enabled=1;
    if($('input:radio[name="shi"]:checked').val()==null){
        enabled=0;
    }
    var types = [];
...
function addDepartment() {
    ...
    var isOrg=0;
     var enabled=1;
    if($('input:radio[name="yes"]:checked').val()==null){
        enabled=0;
    }
    $.ajax({
        type: "POST",
