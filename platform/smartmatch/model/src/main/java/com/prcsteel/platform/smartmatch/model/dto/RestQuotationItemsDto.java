 ...
 *
 * @author peanut
 * @date 2016/6/20 13:52
 */
public class RestQuotationItemsDto implements Serializable {
     ...
     * 明细集
     */
    private List<RestQuotationItems> items;

    /**
     * 报价明细
     */
    public static class RestQuotationItems implements Serializable{
    ...
    public List<RestQuotationItems> getItems() {
        return items;
    }

    public void setItems(List<RestQuotationItems> items) {
        this.items = items;
    }
