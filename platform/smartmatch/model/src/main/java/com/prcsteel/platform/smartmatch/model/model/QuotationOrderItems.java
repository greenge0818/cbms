...
public class QuotationOrderItems {
    private Long id;

    private Long inquiryOrderItemsId;

    private Long sellerId;
    
    private String sellerName;//卖家名称
    
    private Long departmentId;//当前的部门
    
	private Integer contactId;
	
	private String contactName;//卖家联系人名称
    ...
    private String categoryName;//品名名称
    ...
    private String factoryName;//钢厂名称
    ...
    private String warehouseName;//材质名称
    ...
    private Integer status;//报价详情的开单状态 0:未开单，1：已开单
    ...
    public Long getInquiryOrderItemsId() {
        return inquiryOrderItemsId;
    }

    public void setInquiryOrderItemsId(Long inquiryOrderItemsId) {
        this.inquiryOrderItemsId = inquiryOrderItemsId;
    }
