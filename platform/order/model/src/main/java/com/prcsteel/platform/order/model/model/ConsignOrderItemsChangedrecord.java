...
public class ConsignOrderItemsChangedrecord {

    public ConsignOrderItemsChangedrecord(){}

    public ConsignOrderItemsChangedrecord(ConsignOrderItems orderItem) {
        this.orderItemId = orderItem.getId();
        this.orderId = orderItem.getOrderId();
        this.sellerId = orderItem.getSellerId();
        this.sellerName = orderItem.getSellerName();
        this.departmentId = orderItem.getDepartmentId();
        this.departmentName = orderItem.getDepartmentName();
        this.contactId = orderItem.getContactId();
        this.contactName = orderItem.getContactName();
        this.nsortName = orderItem.getNsortName();
        ...
        this.warehouse = orderItem.getWarehouse();
        this.quantity = orderItem.getQuantity();
        this.weight = orderItem.getWeight();
        this.weightConcept = orderItem.getWeightConcept();
        this.costPrice = orderItem.getCostPrice();
        this.dealPrice = orderItem.getDealPrice();
        this.purchaseAmount = orderItem.getCostPrice().multiply(orderItem.getWeight()).setScale(2, BigDecimal.ROUND_HALF_UP);
        this.saleAmount = orderItem.getDealPrice().multiply(orderItem.getWeight()).setScale(2, BigDecimal.ROUND_HALF_UP);
        this.isPayedByAcceptDraft = orderItem.getIsPayedByAcceptDraft();
        this.acceptDraftId = orderItem.getAcceptDraftId();
        this.acceptDraftCode = orderItem.getAcceptDraftCode();
        this.strappingNum = orderItem.getStrappingNum();
        this.created = new Date();
        this.lastUpdated = new Date();
    }

    public ConsignOrderItemsChangedrecord(ConsignOrderItemsChange orderItem) {
        this.itemChangeId = orderItem.getId();
