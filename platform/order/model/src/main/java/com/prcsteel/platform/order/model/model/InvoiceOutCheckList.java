...
public class InvoiceOutCheckList {
    private Long id;
    ...
    private InvoiceOutSendStatus sendStatus;
	...
	public InvoiceOutSendStatus getSendStatus() {
		return sendStatus;
	}

	public void setSendStatus(InvoiceOutSendStatus sendStatus) {
