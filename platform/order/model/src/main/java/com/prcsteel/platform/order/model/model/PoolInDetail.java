...
public class PoolInDetail {
    ...
    public PoolInDetail(Long poolInId, String nsortName, String material, String spec, BigDecimal totalAmount, BigDecimal totalWeight, String loginId) {
        Date now = new Date();
        ...
        this.receivedWeight = BigDecimal.ZERO;
        this.created = now;
