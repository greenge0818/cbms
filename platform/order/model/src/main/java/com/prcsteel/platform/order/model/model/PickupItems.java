...
public class PickupItems {
    ...
    private Long consignOrderItemId;
    ...
    private int leftQuantity;//可提数量
    
    private Long orderItemId;//订单资源详情id
    
    private BigDecimal weight;//订单资源重量
    ...
    public Long getConsignOrderItemId() {
        return consignOrderItemId;
    }

    public void setConsignOrderItemId(Long consignOrderItemId) {
        this.consignOrderItemId = consignOrderItemId;
    }
