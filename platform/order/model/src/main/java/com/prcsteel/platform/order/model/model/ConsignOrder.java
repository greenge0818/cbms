...
public class ConsignOrder {
    ...
    private Integer changeOrderId;//变更订单id
    ...
    private String paymentSort;   //付款类型

    private String requirementCode; //需求单号

    private String transArea; //交货地

    private String origin; //订单来源： 空， SMART_MATCH(找货)，

    private Integer financeOrder; //是否为融资订单
