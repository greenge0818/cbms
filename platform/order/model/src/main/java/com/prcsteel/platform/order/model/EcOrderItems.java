...
public class EcOrderItems {
    ...
    private String spec1;//品规

    private String spec2;//品规

    private String spec3;//品规

    private String factoryId;//钢厂ID

    private String factoryName;//钢厂

    private BigDecimal price;//单价

    private String cityId;//仓库所在城市ID

    private String cityName;//仓库所在城市名称
