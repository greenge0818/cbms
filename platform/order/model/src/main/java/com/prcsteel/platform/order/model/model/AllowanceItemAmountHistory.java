...
public class AllowanceItemAmountHistory {
    private Long id;

    private Long allowanceItemDetailId;
    ...
    public Long getAllowanceItemDetailId() {
		return allowanceItemDetailId;
	}

	public void setAllowanceItemDetailId(Long allowanceItemDetailId) {
		this.allowanceItemDetailId = allowanceItemDetailId;
	}
