...
public class PoolOut {
    ...
    private BigDecimal totalSentWeight;
    ...
    public PoolOut(Long orgId, String orgName, Long ownerId, String ownerName, Long buyerId,
                   String buyerName,Long departmentId, String departmentName, BigDecimal totalAmount,
                   BigDecimal totalWeight, String loginId) {
        Date now = new Date();
        this.orgId = orgId;
        ...
        this.totalSentAmount = BigDecimal.ZERO;
        this.totalSentWeight = BigDecimal.ZERO;
        this.created = now;
    ...
    public BigDecimal getTotalSentWeight() {
        return totalSentWeight;
    }

    public void setTotalSentWeight(BigDecimal totalSentWeight) {
        this.totalSentWeight = totalSentWeight;
    }
