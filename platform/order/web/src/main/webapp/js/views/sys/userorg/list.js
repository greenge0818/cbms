...
jQuery(function ($) {
    ...
    onSearchClick();
    //添加配置
    $("#addConfig").on(ace.click_event, function () {
        location = "create.html";
    });
});
function initTable() {
    var url = Context.PATH + "/sys/userorg/search.html";
        ...
        , columnDefs: [
            {
                ...
                "render": function (data, type, full, meta) {
                    ...
                    var url = Context.PATH + "/sys/userorg/" + full.userId + ".html";
...
function initClickEvent() {
    ...
    $(".table").on("click", ".delete", function(){
        ...
        cbms.confirm("确定删除？",null,function(){
            $.ajax({
                type: 'post',
                url: Context.PATH + "/sys/userorg/" + data.userId + "/delete.html",
