	...
	*/
	function formSubmit(e){
	 	if (setlistensSave("#areaForm")) {
			...
			if(utils.isEmpty(id)) {
                add(name, centerCityId, refCityIds);
            } else {
                edit(id,name, centerCityId, refCityIds);
            }
		}
	}
	/**
	 ...
	 */
	function edit(id,name, centerCityId, refCityIds){
		$.ajax({
            type: "POST",
	 ...
	 * @param refCityIds     周边城市id集
	 */
	function add(name, centerCityId, refCityIds) {
