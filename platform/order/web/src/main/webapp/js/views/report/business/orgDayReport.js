...
function getCols(){
    $.ajax({
        type : "POST",
        url : Context.PATH + "/report/business/getorgdayreportcolumns.html",
...
function initTable() {
    dt = $("#dynamic-table").DataTable({
        ...
        "ajax": {
            "url": Context.PATH + "/report/business/loadorgdayreportdata.html",
            "type": "POST",
            data: function (d) {
...
function exportExcel() {
    ...
    form.attr('action', Context.PATH + "/report/business/exportorgdayreport.html");
