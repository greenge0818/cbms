...
//			}
			var data={
				...
				remark:$("#remark").val(),
				status:$("#myTab4 li.active input").val()
			};
...
//						$('#dynamic-table').dataTable().fnSettings()._iDisplayStart;
						//刷新datatables当前页
//						var pageNum=$('.paginate_button.active a').text();
//						$('#dynamic-table').dataTable().fnPageChange(Number(pageNum)-1);
						searchData(false);
					}
