...
$(document).ready(function () {
        ...
        ajax: {
            url: Context.PATH + '/order/paymentmanager/get/request.html',
            type: "POST", 
            data: function (d) {
            	...
            	$("#status li").each(function(){
            		...
            		if(checkbox.prop('checked')){
            			var pay_status = checkbox.val();
            			if(pay_status!='all'){
            				status.push(pay_status);
            			}
            		}
            	});
        ...
        fnRowCallback: function (nRow, aData, iDataIndex) {
             ...
             if (aData.type == "2") {
            	 ...
            	 link = '<a href="'+Context.PATH+'/order/paymentmanager/paymentrequest.html?payItemId='+aData.payItemId+'">查看详情</a>';
