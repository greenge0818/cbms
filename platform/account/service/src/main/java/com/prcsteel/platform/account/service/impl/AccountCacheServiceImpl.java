 ...
 */
@Service("cacheServiceAccount")
public class AccountCacheServiceImpl implements CacheService {

    private static Logger LOG = LoggerFactory.getLogger(AccountCacheServiceImpl.class);
