 ...
 * 卖家代运营协议状态
 */
public enum SellerConsignAgreementStatus {
    ToPrint("ToPrint", "待打印"),
    ...
    // 构造方法
    SellerConsignAgreementStatus(String code, String name) {
        this.code = code;
        this.name = name;
    }

    public static String getNameByCode(String code) {
        Optional<SellerConsignAgreementStatus> res = Stream.of(SellerConsignAgreementStatus.values()).filter(a -> a.getCode().equals(code)).findFirst();
    ...
    public static List<Map<String, String>> getList() {
        ...
        SellerConsignAgreementStatus[] array = SellerConsignAgreementStatus.values();
        for (SellerConsignAgreementStatus status : array) {
            map = new HashMap<>();
