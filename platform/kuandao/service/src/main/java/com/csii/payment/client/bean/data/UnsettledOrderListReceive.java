...
/*    */ 
/*    */ public class UnsettledOrderListReceive extends DataReceive
/*    */ {
/*    */   private int _$1116;
...
/* 49 */       switch (cycle % 5) { case 0:
/* 50 */         String oid = st.nextToken(); order = new HashMap(); order.put("orderId", oid == null ? oid : oid.trim()); break;
/*    */       case 1:
...
/*    */       case 4:
/* 54 */         order.put("seqNo", st.nextElement()); this._$1389.add(order);
/*    */       }
/* 56 */       cycle++;
/*    */     }
/*    */   }
 ...
 * Qualified Name:     com.csii.payment.client.bean.data.UnsettledOrderListReceive
