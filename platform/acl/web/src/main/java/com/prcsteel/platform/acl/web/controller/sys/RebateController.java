package com.prcsteel.platform.acl.web.controller.sys;
...
import com.prcsteel.platform.acl.api.RestRebateService;
import com.prcsteel.platform.acl.web.controller.BaseController;
...
public class RebateController extends BaseController {
	...
	@Resource
	RestRebateService restRebateService;
	@Autowired
	...
	public String setrebate(ModelMap out) {
		out.put("tab", "rebate");
		out.put("rebate", restRebateService.getAllRebateDto());
	...
	public String saveReward(ModelMap out, @RequestParam("cat_uuid") String[] cat_uuid,
		...
		this.restRebateService.refleshRebate(rebateList);
